...
for varname in os.listdir("train_attention"):
    ...
    for model_name in os.listdir("train_attention/" + varname + "/predictions/test/"):

        predicted_all[varname][model_name] = dict()
        y_test_all[varname][model_name] = dict() 

        for filename in os.listdir("train_attention/" + varname + "/predictions/test/" + model_name):
 
            final_test_data = pd.read_csv("train_attention/" + varname + "/predictions/test/" + model_name + "/" + filename, sep = ";", index_col = False)
